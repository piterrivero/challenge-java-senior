...
import it.techgap.challenge.java.senior.beans.impl.ManagerEmployee;
import it.techgap.challenge.java.senior.beans.impl.SalesmanEmployee;
import it.techgap.challenge.java.senior.beans.impl.TechnicianEmployee;
...
public class Challenge03SimpleProgram {
    ...
    public static Employee getTechnician(String name, int startingSalary) {
        return new TechnicianEmployee(name, startingSalary);
    }
    ...
    public static Employee getSalesman(String name, int startingSalary, int monthlySales) {
    	return new SalesmanEmployee(name, startingSalary, monthlySales);
    }
    ...
    public static Employee getManager(String name, int startingSalary, Employee... directSubordinates) {
    	return new ManagerEmployee(name, startingSalary, directSubordinates);
    }
}
